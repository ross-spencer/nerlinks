...
func makeNERDataConnection(VERB string, request string, content string) string {
   ...
   req.Header.Set("User-Agent", "exponentialDK-triage")
   req.Header.Set("Accept", "*/*")   

   resp, err := http.DefaultClient.Do(req)
   if err != nil {
      fmt.Println("Error querying server:", err)
   }
